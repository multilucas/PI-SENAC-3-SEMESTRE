        ...
        <div class="max-w-md w-full bg-gray-700 dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-6">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-800 mb-3 leading-tight focus:outline-none focus:shadow-outline"
