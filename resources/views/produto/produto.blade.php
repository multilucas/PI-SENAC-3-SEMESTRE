    ...
    <div class="bg-gray-900">
        <div class="pt-6">
                ...
                <ol role="list"
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="{{ route('produtos.main') }}"
                                class="mr-2 text-sm font-medium text-gray-900 dark:text-white">Loja</a>
                    ...
                    <li>
                        <div class="flex items-center">
                            <a href="{{ route('produtos') }}" class="mr-2 text-sm font-medium text-white">Todos os
                                Jogos</a>
                            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor"
                                aria-hidden="true" class="h-5 w-4 text-">
                                <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                            </svg>
                        </div>
                    </li>
                    ...
                    <li class="text-sm">
                        <a href="#" aria-current="page"
                            class="font-medium text-gray-500 hover:text-gray-600">{{ $produto->categoria->CATEGORIA_NOME }}</a>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                <div class="aspect-h-3 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
                    <img src="{{ $produto->imagensOrdenadas[0]->IMAGEM_URL ?? '' }}" alt="Imagem do produto"
                        class="h-full w-full  object-center">
                </div>
                <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                    <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                        <img src="{{ $produto->imagensOrdenadas[1]->IMAGEM_URL ?? '' }}" alt="Imagem do produto"
                            class="h-full w-full object-cover object-center">
                    </div>
                    <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                        <img src="{{ $produto->imagensOrdenadas[2]->IMAGEM_URL ?? '' }}" alt="Imagem do produto"
                            class="h-full w-full  object-center">
                    </div>
                </div>
                <div class="aspect-h-4 aspect-w-4 lg:aspect-h-3 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
                    <img src="{{ $produto->imagensOrdenadas[3]->IMAGEM_URL ?? '' }}" alt="Imagem do produto"
                        class="h-full w-full object-cover object-center">
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                <h1 class="text-2xl font-bold tracking-tight text-white sm:text-3xl">{{ $produto->PRODUTO_NOME }}
                </h1>
            </div>
            ...
            <div class="mt-4 lg:row-span-3 lg:mt-0">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center">
                        <div class="flex items-center">
                            ...
                            <svg class="text-gray-700 h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
                ...
                <form class="mt-10" action="{{ route('adicionar-ao-carrinho', $produto->PRODUTO_ID) }}">
                    ...
                    <div>
                        ...
                        <fieldset class="mt-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <img class="w-7 h-7"
                                    src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/39fd3cf6-e264-4c96-a034-e9e469461bfc/d69yvt3-5b8e9bba-2238-4b33-8e3f-619e41b71073.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..xGN14P3HzTWzsLSmO5B5C2rRrxPO7cfBGTz_4O44PCY">
                    ...
                    <label class="mt-5 flex  text-base font-medium text-white "
                        for="quantidade_itens">Quantidade</label>
                    <input type="number" name="quantidade_itens" value=""
                        class="border mt-5 rounded-l px-3 py-2 text-sm focus:outline-none focus:ring focus:border-blue-300 bg-gray-200 rounded-md">

                    <button type="submit"
                        class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Adicionar
                        ao Carrinho</button>
                </form>
            </div>
