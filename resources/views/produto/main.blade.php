                                                ...
                                                <div class="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                                                    ...
                                                    <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                                                        ...
                                                        <div class="sm:col-span-8 lg:col-span-7">
                                                            <h2 class="text-2xl font-bold text-gray-900 sm:pr-12">{{ $produto->PRODUTO_NOME}}</h2>

                                                            <section aria-labelledby="information-heading" class="mt-2">
                                                                <h3 id="information-heading" class="sr-only">Product information</h3>

                                                                <p class="text-2xl text-gray-900">{{$produto->PRODUTO_PRECO}}</p>
                                                            ...
                                                            <section aria-labelledby="options-heading" class="mt-10">
                                                                ...
                                                                <form>
                                                                    ...
                                                                    <!-- Sizes -->
                                                                    <div class="mt-10">
                                                                        <p class="text-xl font-semibold tracking-tight text-gray-900 "">{{ $produto->PRODUTO_DESC }}</p>
                                                                    </div>
